...
_CN.MATCHER = CN()
_CN.MATCHER.TYPE = 'loftr' # [loftr, superglue]
##############  ↓  LoFTR Pipeline  ↓  ##############
_CN.LOFTR = CN()
...
_CN.FUNDAMENTAL_MATRIX = CN()
_CN.FUNDAMENTAL_MATRIX.P = 1.0
_CN.FUNDAMENTAL_MATRIX.NUM_IRLS_STEPS = 500
_CN.FUNDAMENTAL_MATRIX.ATOL = 1e-8
_CN.FUNDAMENTAL_MATRIX.RTOL = -1.
_CN.FUNDAMENTAL_MATRIX.EPS = 1e-6
_CN.FUNDAMENTAL_MATRIX.LEARN_P = False
_CN.FUNDAMENTAL_MATRIX.INITIAL_P = -1.0
_CN.FUNDAMENTAL_MATRIX.INITIAL_NUM_IRLS_STEPS = 100
_CN.FUNDAMENTAL_MATRIX.ROBUST_ESTIMATOR_TYPE = 'LIRLS' # LIRLS, DFE, IRLS
_CN.FUNDAMENTAL_MATRIX.MATRIX_TYPE = 'F' # F, E
_CN.FUNDAMENTAL_MATRIX.COMPUTE_COARSE = False
_CN.FUNDAMENTAL_MATRIX.COMPUTE_FINE = False
...
_CN.LOFTR.LOSS.COARSE_POSE_WEIGHT = 0.0
_CN.LOFTR.LOSS.FINE_POSE_WEIGHT = 0.0
_CN.LOFTR.LOSS.COARSE_IRLS_WEIGHT = 0.0
_CN.LOFTR.LOSS.FINE_IRLS_WEIGHT = 0.0
_CN.LOFTR.LOSS.COARSE_POSE_TYPE = 'cosine'
_CN.LOFTR.LOSS.FINE_POSE_TYPE = 'cosine'
_CN.LOFTR.LOSS.ROTATION_WEIGHT = 1.0
_CN.LOFTR.LOSS.ANGULAR_LOSS = True

# -- Fundamental/Essential matrix estimation loss
_CN.LOFTR.LOSS.FINE_EPIPOLAR_MATCH_WEIGHT = 0.0
_CN.LOFTR.LOSS.FINE_EPIPOLAR_MATCH_TYPE = 'F'

_CN.LOFTR.LOSS.SUPERGLUE_MATCH_WEIGHT = 0.0
...
_CN.TRAINER.AMSGRAD_CORRECTION = False
...
# freezing subparts
_CN.TRAINER.FREEZE_MATCHER = False
