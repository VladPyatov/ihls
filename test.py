...
if __name__ == '__main__':
    ...
    model = PL_LoFTR.load_from_checkpoint(args.ckpt_path, strict=False, config=config, profiler=profiler, dump_dir=args.dump_dir)
    #model = PL_LoFTR(config=config, pretrained_ckpt=args.ckpt_path, profiler=profiler, dump_dir=args.dump_dir)
